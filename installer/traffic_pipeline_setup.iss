#define MyAppName "Jingyuan AI Threat Perception Platform"
...
Source: "{#SourceRoot}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: ".git\*,.github\*,dist\*,installer\build\*,output\*,input\*,result\*,result_threshold_test\*,__pycache__\*,.venv\*,venv\*,node_modules\*,*.pyc,*.pyo,*.log,*.tmp,llm\rag\*.db,llm\rag\*.db-*,models\best_mlp_legacy_*.pth"
...
[Run]
Filename: "{app}\{#MyAppExe}"; Description: "Run one-click environment setup and start platform now"; Flags: postinstall skipifsilent
